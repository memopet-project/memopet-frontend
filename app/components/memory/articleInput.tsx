  ...
  return (
    <div className='relative w-[400px]'>
      <input 
        ...
        type='text'
        className="
          mb-2 px-3 text-base font-normal flex items-center border border-solid border-gray03 rounded-md w-full h-14 font-pretendard
          focus:outline-none focus:border-red05
        "
        value={inputValue} 
